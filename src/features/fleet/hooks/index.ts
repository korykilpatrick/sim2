...
export const fleetKeys = {
  ...
  vessels: (fleetId: string) => [...fleetKeys.detail(fleetId), 'vessels'] as const,
  vesselSearch: (fleetId: string, query: string) => [...fleetKeys.vessels(fleetId), 'search', query] as const,
}
