...
describe('Auth Service', () => {
  ...
  describe('login', () => {
    ...
    it('should throw error on login failure', async () => {
      ...
      await expect(authApi.login(loginCredentials)).rejects.toThrow(errorMessage);
      expect(apiClient.post).toHaveBeenCalledWith('/auth/login', loginCredentials);
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(authApi.login(loginCredentials)).rejects.toThrow('Network error');
    });
  ...
  describe('register', () => {
    ...
    it('should handle missing required fields', async () => {
      ...
      expect(apiClient.post).toHaveBeenCalledWith('/auth/register', incompleteData);
    });
  });
  ...
  describe('refreshToken', () => {
    ...
    it('should throw error on refresh failure', async () => {
      ...
      await expect(authApi.refreshToken(refreshToken)).rejects.toThrow(errorMessage);
      expect(apiClient.post).toHaveBeenCalledWith('/auth/refresh', { refreshToken });
    });
    ...
    it('should handle empty refresh token', async () => {
      ...
      expect(apiClient.post).toHaveBeenCalledWith('/auth/refresh', { refreshToken: emptyToken });
    });
  });
