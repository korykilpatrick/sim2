...
describe('useWebSocket', () => {
  ...
  describe('Event Handling', () => {
    it('should subscribe to events', () => {
      ...
      expect(websocketService.on).toHaveBeenCalledWith('vessel_position_update', handler);
    });
    ...
    it('should provide off method for unsubscribing', () => {
      ...
      expect(websocketService.off).toHaveBeenCalledWith('vessel_position_update', handler);
    });
    ...
    it('should handle multiple event subscriptions', () => {
      ...
      expect(websocketService.on).toHaveBeenCalledWith('credit_balance_updated', handler2);
    });
  });
  ...
  describe('Room Management', () => {
    ...
    it('should leave vessel room', () => {
      ...
      expect(websocketService.leaveVesselRoom).toHaveBeenCalledWith('vessel-123');
    });
