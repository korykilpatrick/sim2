...
describe('WebSocketService', () => {
  ...
  describe('Authentication', () => {
    ...
    it('should handle authentication success', () => {
      const authHandler = mockSocket.on.mock.calls.find((call: any) => call[0] === 'authenticated')?.[1];
      if (authHandler) {
    ...
    it('should handle authentication failure', () => {
      const unauthorizedHandler = mockSocket.on.mock.calls.find((call: any) => call[0] === 'unauthorized')?.[1];
  ...
  describe('Room Management', () => {
    ...
    it('should leave vessel room', () => {
      ...
      expect(mockSocket.emit).toHaveBeenCalledWith('leave_vessel_room', 'vessel-123');
      
      const rooms = service.getRooms();
      expect(rooms).not.toContainEqual(expect.objectContaining({
        room: 'vessel-123'
      }));
    });
    ...
    it('should leave area room', () => {
      ...
      expect(mockSocket.emit).toHaveBeenCalledWith('leave_area_room', 'area-456');
  ...
  describe('Event Handling', () => {
    ...
    it('should subscribe to events', () => {
      ...
      // Simulate event
      const eventHandler = mockSocket.on.mock.calls.find((call: any) => call[0] === 'vessel_position_update')?.[1];
      if (eventHandler) {
        const positionData = {
          vesselId: 'vessel-1',
    ...
    it('should handle multiple listeners for same event', () => {
      ...
      // Simulate event
      const eventHandler = mockSocket.on.mock.calls.find((call: any) => call[0] === 'area_alert')?.[1];
      if (eventHandler) {
        const alertData = {
          id: 'alert-1',
          areaId: 'area-1',
    ...
    it('should unsubscribe from events', () => {
      ...
      const eventHandler = mockSocket.on.mock.calls.find((call: any) => call[0] === 'credit_balance_updated')?.[1];
      if (eventHandler) {
  ...
  describe('Alert Management', () => {
    ...
    it('should mark alert as read', () => {
      ...
      expect(mockSocket.emit).toHaveBeenCalledWith('mark_alert_read', 'alert-123');
    });
  ...
  describe('Reconnection Logic', () => {
    ...
    it('should handle reconnection attempts', () => {
      ...
      const reconnectAttemptHandler = mockSocket.io.on.mock.calls.find((call: any) => call[0] === 'reconnect_attempt')?.[1];
    ...
    it('should handle reconnection success', () => {
      ...
      // Simulate reconnection
      const reconnectHandler = mockSocket.io.on.mock.calls.find((call: any) => call[0] === 'reconnect')?.[1];
      if (reconnectHandler) {
        reconnectHandler(1);
      }
    ...
    it('should handle reconnection failure', () => {
      ...
      const reconnectFailedHandler = mockSocket.io.on.mock.calls.find((call: any) => call[0] === 'reconnect_failed')?.[1];
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing event listeners gracefully', () => {
      ...
      const eventHandler = mockSocket.on.mock.calls.find((call: any) => call[0] === 'server_message')?.[1];
      if (eventHandler) {
        // Should not throw
        expect(() => {
